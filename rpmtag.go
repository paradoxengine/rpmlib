...
const (
	...
	RPMTAG_SUGGESTSNAME      RpmTagVal = C.RPMTAG_SUGGESTSNAME
	RPMTAG_SUGGESTS          RpmTagVal = C.RPMTAG_SUGGESTS
	RPMTAG_SUGGESTSVERSION   RpmTagVal = C.RPMTAG_SUGGESTSVERSION
	RPMTAG_SUGGESTSFLAGS     RpmTagVal = C.RPMTAG_SUGGESTSFLAGS
	RPMTAG_ENHANCESNAME      RpmTagVal = C.RPMTAG_ENHANCESNAME
	RPMTAG_ENHANCES          RpmTagVal = C.RPMTAG_ENHANCES
	RPMTAG_ENHANCESVERSION   RpmTagVal = C.RPMTAG_ENHANCESVERSION
	RPMTAG_ENHANCESFLAGS     RpmTagVal = C.RPMTAG_ENHANCESFLAGS
